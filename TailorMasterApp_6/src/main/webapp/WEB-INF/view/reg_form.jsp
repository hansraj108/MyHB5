		...
		<tr>
			...
			<f:form action="${url_reg}" modelAttribute="command"> 
					 <table border="1">
                            <tr>
                                <td>First Name</td>
                                <td><f:input path="user.firstName"/></td>
                            </tr>
                            <tr>
                                <td>Last Name</td>
                                <td><f:input path="user.lastName"/></td>
                            </tr>
                            <tr>
                                <td>Phone</td>
                            ...
                            <tr>
                                <td>Country</td>
                                <td><f:input path="user.country"/></td>
                            </tr>
                            <tr>
                                <td>State</td>
                                <td><f:input path="user.state"/></td>
                            </tr>
                            <tr>
                                <td>City</td>
                                <td><f:input path="user.city"/></td>
                            </tr>
                            <tr>
                                <td>Username</td>
