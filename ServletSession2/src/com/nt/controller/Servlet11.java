...
if(mstatus.equals("married")) {
		...
		pw.println("<b><input type='hidden' name='hname' value="+name+">");
		pw.println("<b><input type='hidden' name='hage' value="+age+">");
		pw.println("<b><input type='hidden' name='hms' value="+mstatus+">");
