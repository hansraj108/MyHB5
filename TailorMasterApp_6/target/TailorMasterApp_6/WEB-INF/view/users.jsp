		...
		<tr>
			...
			<table border="1">
				...
				<s:url  var="url_usersview" value="/usersList"></s:url>
					...
					<a href="${url_usersview}.pdf">Download Pdf File</a> | <a href="${url_usersview}.xls">Download Xls File</a> | <a href="${url_usersview}.xlsx">Download Xlsx File</a> | <a href="${url_usersview}.json">View in JSON format</a> | <a href="${url_usersview}.xml">View in XML format</a> | <a href="${url_usersview}">View in HTML format</a>
					</td>
				</tr>
			</table>
			</td>
