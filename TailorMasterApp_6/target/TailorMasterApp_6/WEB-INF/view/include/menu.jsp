...
<s:url var="url_clist" value="/user/custList"></s:url>
<s:url var="url_showAll" value="/user/showAllOrder"></s:url>
<s:url var="url_doclist" value="/user/doclist1"></s:url>
<a href="${url_uhome}">Home</a> | <a href="${url_cform}">Add Customer</a> | <a href="${url_clist}">Customer List</a> | <a href="${url_doclist}">Document List</a> | <a href="${url_logout}">Logout</a>
</c:if>
